...
//Copied locally because of a "cors" error 
const jsonData = {
    "success": 1,
    "error": 0,
    "data": {
...
function main() {
    ...
    // fetch(guideURL, {mode: 'cors', headers: {
...
/**
 * The function loads the css code from the JSON to the page
 */
function loadCSS(){
...
/**
 * The function creates a new step from the given steps array
 */
...
/**
 * The function implements the "watchDpg" attribute
 */
function watchDog(){
